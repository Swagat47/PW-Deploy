...
const ContactUsPage = () => {
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    axios
      .post(`${backendUrl}/api/contact`, {name, email, message})
      .then((res) => {
        setName("");
        setEmail("");
        setMessage("");
    ...
    <div className="BG h-screen w-screen">
        ...
        <div className="flex col-span-10">
          <div className="flex justify-between self-end bg-our-blue text-white font-robotoslab font-medium w-full h-3/4 px-20">
            <div className="flex items-center text-navtext h-full">
              <div className="text-navbigtext">Contact Us</div>
            </div>
            <div className="flex items-center text-navtext h-full">
      ...
      <div className="container my-24 px-6 mx-auto">
        ...
        <section className="mb-32 text-gray-800">
          ...
          {/* <div className="relative overflow-hidden bg-no-repeat bg-cover background-position: 50%;  height: 300px;">
    <img className="object-contain h-20 w-20" src={nithlogo} alt="" />
    </div> */}
          <div className="container text-gray-800 px-4 md:px-12">
            <div className="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6 margin-top: -100px; background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
              ...
              " id="exampleFormControlTextarea13" placeholder="Message"></input>
                    </div>
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                          <p className="font-bold mb-1">Placement Questions</p>
                          <p className="text-gray-500">placement@example.com</p>
                          <p className="text-gray-500">+1 234-567-89</p>
                        </div>
                      </div>
                    </div>
                    <div className="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                      <div className="flex align-start">
                        ...
                        <div className="grow ml-6">
                          <p className="font-bold mb-1">TPO</p>
                          <p className="text-gray-500">tpo@example.com</p>
                          <p className="text-gray-500">+1 234-567-89</p>
                        </div>
                      </div>
                    </div>
